...
During the first week of the internship, the focus was mainly on understanding the fundamental concepts related to data and data analysis. We started by learning what data is and why it is important in different industries and organizations.

We discussed the importance of data and how organizations use data to make data-driven decisions. I also learned about different types of data and how data can exist in different forms depending on the context in which it is used.

Another concept introduced during this week was data visualization, which refers to representing data in a visual or graphical form so that patterns and insights can be understood more easily.
